...
// const PopularBooks = () => {
//   // Safely access books list with a fallback to an empty array
//   const rawBooks = useSelector((state) => state.books?.list || []);
//   const books = rawBooks.slice().reverse(); // Create a reversed copy
